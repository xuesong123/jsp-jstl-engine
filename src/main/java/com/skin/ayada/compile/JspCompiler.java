...
public class JspCompiler
{
    ...
    public void writeHeader(PrintWriter writer, Template template, String className, String packageName)
    {
        ...
        writer.println(" * options: -fastJstl " + this.getFastJstl());
        ...
        writer.println("import java.io.Writer;");
        ...
        writer.println("import com.skin.ayada.tagext.JspFragment;");
    ...
    public void writeClass(PrintWriter writer, List<Node> list, int offset, int length)
    {
        ...
        for(int index = offset, end = offset + length; index < end; index++)
        {
            ...
            tagClassName = node.getTagClassName();
    ...
    protected boolean hasParent(Node node)
    {
        ...
        if(parent != null)
        {
            ...
            boolean b = (parentTagName.equals("c:if")
