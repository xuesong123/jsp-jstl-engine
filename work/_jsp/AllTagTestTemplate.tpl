...
[NODE]: <c:forEach lineNumber="103" offset="98" length="20" tagClass="com.skin.ayada.jstl.core.ForEachTag" tagFactory="com.skin.ayada.jstl.factory.ForEachTagFactory" items="${userList}" var="user" varStatus="status">
[TEXT]: \r\n    <p>user: 
[EXPR]: ${user.userName}
[TEXT]: </p>\r\n    
...
[NODE]: <c:choose lineNumber="114" offset="119" length="14" tagClass="com.skin.ayada.jstl.core.ChooseTag" tagFactory="com.skin.ayada.jstl.factory.ChooseTagFactory">
[NODE]: <c:when lineNumber="115" offset="120" length="3" tagClass="com.skin.ayada.jstl.core.WhenTag" tagFactory="com.skin.ayada.jstl.factory.WhenTagFactory" test="${1 == 1}">
[TEXT]: c:when test=\"{1 == 1}\"
[NODE]: </c:when>
[NODE]: <c:when lineNumber="116" offset="123" length="3" tagClass="com.skin.ayada.jstl.core.WhenTag" tagFactory="com.skin.ayada.jstl.factory.WhenTagFactory" test="${2 == 2}">
[TEXT]: c:when test=\"{2 == 2}\"
[NODE]: </c:when>
[NODE]: <c:when lineNumber="117" offset="126" length="3" tagClass="com.skin.ayada.jstl.core.WhenTag" tagFactory="com.skin.ayada.jstl.factory.WhenTagFactory" test="${3 == 3}">
[TEXT]: c:when test=\"{3 == 3}\"
[NODE]: </c:when>
[NODE]: <c:otherwise lineNumber="118" offset="129" length="3" tagClass="com.skin.ayada.jstl.core.OtherwiseTag" tagFactory="com.skin.ayada.jstl.factory.OtherwiseTagFactory">
[TEXT]: c:otherwise
[NODE]: </c:otherwise>
[NODE]: </c:choose>
[TEXT]: \r\n\r\n<h1>app:test test1</h1>\r\n
[NODE]: <app:test lineNumber="122" offset="134" length="2" tagClass="com.skin.ayada.jstl.core.TestTag" tagFactory="com.skin.ayada.jstl.factory.TestTagFactory" myBoolean="true" myChar="c" myByte="1" myInt="-1.0" myFloat="1.0f" myDouble="1.0d" myLong="1L" myString="Hello">
[NODE]: </app:test>
[TEXT]: \r\n
[NODE]: <app:test lineNumber="123" offset="137" length="2" tagClass="com.skin.ayada.jstl.core.TestTag" tagFactory="com.skin.ayada.jstl.factory.TestTagFactory" myBoolean="false" myChar="c" myByte="243" myInt="-1.0" myFloat="1.0F" myDouble="1.0D" myLong="1L" myString="Hello">
[NODE]: </app:test>
[TEXT]: \r\n
[NODE]: <app:test lineNumber="124" offset="140" length="2" tagClass="com.skin.ayada.jstl.core.TestTag" tagFactory="com.skin.ayada.jstl.factory.TestTagFactory" myInt="-1.0" myFloat="1.0" myDouble="1e3" myLong="1e3" myString="Hello">
[NODE]: </app:test>
[TEXT]: \r\n
[NODE]: <app:test lineNumber="125" offset="143" length="2" tagClass="com.skin.ayada.jstl.core.TestTag" tagFactory="com.skin.ayada.jstl.factory.TestTagFactory" myInt="-1.0" myFloat="1.0" myDouble="1.2e3" myLong="1.2e3" myString="Hello">
[NODE]: </app:test>
[TEXT]: \r\n\r\n<h1>app:scrollpage test1</h1>\r\n
[NODE]: <app:scrollpage lineNumber="128" offset="146" length="2" tagClass="test.com.skin.ayada.taglib.ScrollPage" tagFactory="test.com.skin.ayada.taglib.proxy.ScrollPageFactory" count="254" pageNum="2" pageSize="10">
[NODE]: </app:scrollpage>
[TEXT]: \r\n\r\n
[NODE]: <app:bodytest lineNumber="130" offset="149" length="2" tagClass="test.com.skin.ayada.taglib.TestBodyTag" tagFactory="test.com.skin.ayada.taglib.proxy.TestBodyTagFactory">
[NODE]: </app:bodytest>
[TEXT]: \r\n
[NODE]: <app:bodytest lineNumber="131" offset="152" length="3" tagClass="test.com.skin.ayada.taglib.TestBodyTag" tagFactory="test.com.skin.ayada.taglib.proxy.TestBodyTagFactory">
[TEXT]: Hello World !
[NODE]: </app:bodytest>
[TEXT]: \r\n
[NODE]: <c:test lineNumber="132" offset="156" length="2" tagClass="com.skin.ayada.jstl.core.TestTag" tagFactory="com.skin.ayada.jstl.factory.TestTagFactory">
[NODE]: </c:test>
[TEXT]: \r\n</body>\r\n</html>
