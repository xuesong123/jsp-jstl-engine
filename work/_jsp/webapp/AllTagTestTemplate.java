 ...
 *
 * LastModified: 2013-11-27 11:55:04 187
 * JSP generated by JspCompiler-0.1.1 (built 2013-11-27 11:55:12 390)
 *
 */
package _jsp.webapp;
...
public class AllTagTestTemplate extends JspTemplate
{
    ...
    out.println("Hello, World4 !");
        ...
        /* NODE START: lineNumber: 103, offset: 98, length: 23, tagClassName: com.skin.ayada.jstl.core.ForEachTag, tagInstanceName: _jsp_ForEachTag_99 */
        ...
        while(_jsp_ForEachTag_99.hasNext()){
            ...
            /* NODE START: lineNumber: 111, offset: 117, length: 2, tagClassName: com.skin.ayada.jstl.core.ContinueTag, tagInstanceName: _jsp_ContinueTag_118 */
            /* <c:continue/> */
            if(1 == 1){ continue; }
            /* jsp.jstl.core.ContinueTag END */
            /* NODE END: lineNumber: 111, tagClassName: com.skin.ayada.jstl.core.ContinueTag, tagInstanceName: _jsp_ContinueTag_118 */
        ...
        /* NODE START: lineNumber: 115, offset: 122, length: 14, tagClassName: com.skin.ayada.jstl.core.ChooseTag, tagInstanceName: _jsp_ChooseTag_123 */
        /* <c:choose>...</c:choose> */
        boolean _jsp_ChooseTag_123 = true;
        ...
        if(_jsp_ChooseTag_123 && ExpressionUtil.getBoolean(expressionContext, "${1 == 1}")){
            _jsp_ChooseTag_123 = false;
            /* TEXT: lineNumber: 116 */
        ...
        if(_jsp_ChooseTag_123 && ExpressionUtil.getBoolean(expressionContext, "${2 == 2}")){
            _jsp_ChooseTag_123 = false;
            /* TEXT: lineNumber: 117 */
        ...
        /* NODE START: lineNumber: 118, offset: 129, length: 3, tagClassName: com.skin.ayada.jstl.core.WhenTag, tagInstanceName: _jsp_WhenTag_130 */
        /* <c:when test="${3 == 3}">...</c:when> */
        if(_jsp_ChooseTag_123 && ExpressionUtil.getBoolean(expressionContext, "${3 == 3}")){
            _jsp_ChooseTag_123 = false;
            /* TEXT: lineNumber: 118 */
            out.write("c:when test=\"{3 == 3}\"");
        } /* jsp.jstl.core.WhenTag END */
        /* NODE END: lineNumber: 118, tagClassName: com.skin.ayada.jstl.core.WhenTag, tagInstanceName: _jsp_WhenTag_130 */

        /* NODE START: lineNumber: 119, offset: 132, length: 3, tagClassName: com.skin.ayada.jstl.core.OtherwiseTag, tagInstanceName: _jsp_OtherwiseTag_133 */
        /* <c:otherwise>...</c:otherwise> */
        if(_jsp_ChooseTag_123){
            _jsp_ChooseTag_123 = false;
            /* TEXT: lineNumber: 119 */
            out.write("c:otherwise");
        } /* jsp.jstl.core.OtherwiseTag END */
        /* NODE END: lineNumber: 119, tagClassName: com.skin.ayada.jstl.core.OtherwiseTag, tagInstanceName: _jsp_OtherwiseTag_133 */

        /* jsp.jstl.core.ChooseTag END */
        /* NODE END: lineNumber: 115, tagClassName: com.skin.ayada.jstl.core.ChooseTag, tagInstanceName: _jsp_ChooseTag_123 */

        /* TEXT: lineNumber: 122 */
        out.write("<h1>app:test test1</h1>\r\n");

        /* NODE START: lineNumber: 123, offset: 137, length: 2, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_138 */
        /* <app:test myBoolean="true" myChar="c" myByte="1" myInt="-1.0" myFloat="1.0f" myDouble="1.0d" myLong="1L" myString="Hello"/> */
        test.com.skin.ayada.taglib.TestTag _jsp_TestTag_138 = new test.com.skin.ayada.taglib.TestTag();
        _jsp_TestTag_138.setParent((Tag)null);
        _jsp_TestTag_138.setPageContext(pageContext);
        _jsp_TestTag_138.setMyBoolean(true);
        _jsp_TestTag_138.setMyChar('c');
        _jsp_TestTag_138.setMyByte((byte)1);
        ...
        int _jsp_flag_138 = _jsp_TestTag_138.doStartTag();
        ...
        do{
            _jsp_flag_138 = _jsp_TestTag_138.doAfterBody();
        }
        while(_jsp_flag_138 == IterationTag.EVAL_BODY_AGAIN);
        _jsp_TestTag_138.doEndTag();
        _jsp_TestTag_138.release();
        /* NODE END: lineNumber: 123, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_138 */

        /* TEXT: lineNumber: 123 */
        out.write("\r\n");

        /* NODE START: lineNumber: 124, offset: 140, length: 2, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_141 */
        /* <app:test myBoolean="false" myChar="c" myByte="243" myInt="-1.0" myFloat="1.0F" myDouble="1.0D" myLong="1L" myString="Hello"/> */
        test.com.skin.ayada.taglib.TestTag _jsp_TestTag_141 = new test.com.skin.ayada.taglib.TestTag();
        _jsp_TestTag_141.setParent((Tag)null);
        _jsp_TestTag_141.setPageContext(pageContext);
        _jsp_TestTag_141.setMyBoolean(false);
        _jsp_TestTag_141.setMyChar('c');
        _jsp_TestTag_141.setMyByte((byte)243);
        _jsp_TestTag_141.setMyInt(-1);
        _jsp_TestTag_141.setMyFloat(1.0f);
        _jsp_TestTag_141.setMyDouble(1.0d);
        _jsp_TestTag_141.setMyLong(1L);
        _jsp_TestTag_141.setMyString("Hello");
        int _jsp_flag_141 = _jsp_TestTag_141.doStartTag();
        ...
        do{
            _jsp_flag_141 = _jsp_TestTag_141.doAfterBody();
        }
        while(_jsp_flag_141 == IterationTag.EVAL_BODY_AGAIN);
        _jsp_TestTag_141.doEndTag();
        _jsp_TestTag_141.release();
        /* NODE END: lineNumber: 124, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_141 */

        /* TEXT: lineNumber: 124 */
        out.write("\r\n");

        /* NODE START: lineNumber: 125, offset: 143, length: 2, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_144 */
        /* <app:test myInt="-1.0" myFloat="1.0" myDouble="1e3" myLong="1e3" myString="Hello"/> */
        test.com.skin.ayada.taglib.TestTag _jsp_TestTag_144 = new test.com.skin.ayada.taglib.TestTag();
        ...
        _jsp_TestTag_144.setMyDouble(1000.0d);
        _jsp_TestTag_144.setMyLong(1000L);
        _jsp_TestTag_144.setMyString("Hello");
        int _jsp_flag_144 = _jsp_TestTag_144.doStartTag();
        ...
        do{
            _jsp_flag_144 = _jsp_TestTag_144.doAfterBody();
        }
        while(_jsp_flag_144 == IterationTag.EVAL_BODY_AGAIN);
        _jsp_TestTag_144.doEndTag();
        _jsp_TestTag_144.release();
        /* NODE END: lineNumber: 125, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_144 */

        /* TEXT: lineNumber: 125 */
        out.write("\r\n");

        /* NODE START: lineNumber: 126, offset: 146, length: 2, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_147 */
        /* <app:test myInt="-1.0" myFloat="1.0" myDouble="1.2e3" myLong="1.2e3" myString="Hello"/> */
        test.com.skin.ayada.taglib.TestTag _jsp_TestTag_147 = new test.com.skin.ayada.taglib.TestTag();
        _jsp_TestTag_147.setParent((Tag)null);
        _jsp_TestTag_147.setPageContext(pageContext);
        _jsp_TestTag_147.setMyInt(-1);
        _jsp_TestTag_147.setMyFloat(1.0f);
        _jsp_TestTag_147.setMyDouble(1200.0d);
        _jsp_TestTag_147.setMyLong(1200L);
        _jsp_TestTag_147.setMyString("Hello");
        int _jsp_flag_147 = _jsp_TestTag_147.doStartTag();

        if(_jsp_flag_147 == Tag.SKIP_PAGE){
            return;
        }

        do{
            _jsp_flag_147 = _jsp_TestTag_147.doAfterBody();
        }
        while(_jsp_flag_147 == IterationTag.EVAL_BODY_AGAIN);
        _jsp_TestTag_147.doEndTag();
        _jsp_TestTag_147.release();
        /* NODE END: lineNumber: 126, tagClassName: test.com.skin.ayada.taglib.TestTag, tagInstanceName: _jsp_TestTag_147 */

        /* TEXT: lineNumber: 126 */
        out.write("\r\n\r\n<h1>app:scrollpage test1</h1>\r\n");

        /* NODE START: lineNumber: 129, offset: 149, length: 2, tagClassName: test.com.skin.ayada.taglib.ScrollPage, tagInstanceName: _jsp_ScrollPage_150 */
        /* <app:scrollpage count="254" pageNum="2" pageSize="10"/> */
        test.com.skin.ayada.taglib.ScrollPage _jsp_ScrollPage_150 = new test.com.skin.ayada.taglib.ScrollPage();
        _jsp_ScrollPage_150.setParent((Tag)null);
        _jsp_ScrollPage_150.setPageContext(pageContext);
        _jsp_ScrollPage_150.setCount(254);
        _jsp_ScrollPage_150.setPageNum(2);
        _jsp_ScrollPage_150.setPageSize(10);
        int _jsp_flag_150 = _jsp_ScrollPage_150.doStartTag();

        if(_jsp_flag_150 == Tag.SKIP_PAGE){
            return;
        }

        do{
            _jsp_flag_150 = _jsp_ScrollPage_150.doAfterBody();
        }
        while(_jsp_flag_150 == IterationTag.EVAL_BODY_AGAIN);
        _jsp_ScrollPage_150.doEndTag();
        _jsp_ScrollPage_150.release();
        /* NODE END: lineNumber: 129, tagClassName: test.com.skin.ayada.taglib.ScrollPage, tagInstanceName: _jsp_ScrollPage_150 */

        /* TEXT: lineNumber: 129 */
        out.write("\r\n\r\n");

        /* NODE START: lineNumber: 131, offset: 152, length: 2, tagClassName: test.com.skin.ayada.taglib.TestBodyTag, tagInstanceName: _jsp_TestBodyTag_153 */
        /* <app:bodytest/> */
        ...
        int _jsp_flag_153 = _jsp_TestBodyTag_153.doStartTag();

        if(_jsp_flag_153 == Tag.SKIP_PAGE){
            return;
        }
        ...
        /* NODE START: lineNumber: 132, offset: 155, length: 3, tagClassName: test.com.skin.ayada.taglib.TestBodyTag, tagInstanceName: _jsp_TestBodyTag_156 */
        /* <app:bodytest>...</app:bodytest> */
        test.com.skin.ayada.taglib.TestBodyTag _jsp_TestBodyTag_156 = new test.com.skin.ayada.taglib.TestBodyTag();
        _jsp_TestBodyTag_156.setParent((Tag)null);
        _jsp_TestBodyTag_156.setPageContext(pageContext);
        int _jsp_flag_156 = _jsp_TestBodyTag_156.doStartTag();

        if(_jsp_flag_156 == Tag.SKIP_PAGE){
            return;
        }
        if(_jsp_flag_156 != Tag.SKIP_BODY && _jsp_flag_156 == BodyTag.EVAL_BODY_BUFFERED){
            BodyContent _jsp_body_content_156 = (BodyContent)(pageContext.pushBody());
            _jsp_TestBodyTag_156.setBodyContent(_jsp_body_content_156);
            _jsp_TestBodyTag_156.doInitBody();
            out = _jsp_body_content_156;
        }

        do{
            /* TEXT: lineNumber: 132 */
            out.write("Hello World !");
            _jsp_flag_156 = _jsp_TestBodyTag_156.doAfterBody();
        }
        while(_jsp_flag_156 == IterationTag.EVAL_BODY_AGAIN);
        _jsp_TestBodyTag_156.doEndTag();
        _jsp_TestBodyTag_156.release();
        if(_jsp_flag_156 != Tag.SKIP_BODY && _jsp_flag_156 == BodyTag.EVAL_BODY_BUFFERED){
            out = pageContext.popBody();
        }
        /* NODE END: lineNumber: 132, tagClassName: test.com.skin.ayada.taglib.TestBodyTag, tagInstanceName: _jsp_TestBodyTag_156 */
