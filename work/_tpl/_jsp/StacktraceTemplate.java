 ...
 * -- /stacktrace.jsp
 *
 * JSP generated by JspCompiler-1.0.1.4 (built 2017-02-09 00:51:36 075)
 */
package _tpl._jsp;
...
public class StacktraceTemplate extends JspTemplate {
                                        ...
                                        if(ExpressionUtil.getBoolean(expressionContext, "${1 == 1}")) {
                                            ...
                                            if(ExpressionUtil.getBoolean(expressionContext, "${1 == 1}")) {
                                                ...
                                                try {
                                                    ...
                                                    this.doFinally(_jsp_StackTraceTag_16);
                                                }
    ...
    protected static final char[] _jsp_string_3 = "/js/jquery-1.4.2.min.js\"></script>\r\n</head>\r\n<body version=\"1.0\">\r\n".toCharArray();
