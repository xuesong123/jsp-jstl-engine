 ...
 * JSP generated by JspCompiler-1.0.1.2 (built 2016-01-12 23:30:07 365)
 */
package _tpl._jsp;
...
public class StacktraceTemplate extends JspTemplate {
    ...
    public void _execute(final PageContext pageContext) throws Throwable {
        ...
        // NODE START: lineNumber: 32, offset: 27, length: 2, tagClassName: com.skin.ayada.jstl.core.IfTag, tagInstanceName: _jsp_IfTag_28
        // <c:if test=\"${user.userName == &#39;xuesong.net&#39;}\">...</c:if>
        if(ExpressionUtil.getBoolean(expressionContext, "${user.userName == \'xuesong.net\'}")) {
        } // jsp.jstl.core.IfTag END
        // NODE END: lineNumber: 32, tagClassName: com.skin.ayada.jstl.core.IfTag, tagInstanceName: _jsp_IfTag_28

        // NODE START: lineNumber: 33, offset: 29, length: 3, tagClassName: com.skin.ayada.jstl.core.ForEachTag, tagInstanceName: _jsp_ForEachTag_30
        // <c:each items=\"${userList}\" var=\"user\">...</c:each>
        Object _jsp_old_var_30 = pageContext.getAttribute("user");
        ...
        _jsp_ForEachTag_30.setVar("user");
        _jsp_ForEachTag_30.setItems(pageContext.getAttribute("userList"));
        ...
        pageContext.setAttribute("user", _jsp_old_var_30);
        // jsp.jstl.core.ForEachTag END
        // NODE END: lineNumber: 33, tagClassName: com.skin.ayada.jstl.core.ForEachTag, tagInstanceName: _jsp_ForEachTag_30
