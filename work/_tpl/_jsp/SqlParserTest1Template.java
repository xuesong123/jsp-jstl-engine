 ...
 * JSP generated by JspCompiler-1.0.1.2 (built 2016-01-12 23:30:06 822)
 */
package _tpl._jsp;
...
public class SqlParserTest1Template extends JspTemplate {
    ...
    public static final char[] _jsp_string_2 = "create table `my_table`(\r\n    `f1`      bigint(20) unsigned not null comment \'����\',\r\n    `f2`      datetime not null comment \'ע��\',\r\n    `f3`      datetime not null comment \'ע��\',\r\n    primary key (f1)\r\n);\r\n".toCharArray();
    public static final char[] _jsp_string_4 = "<p>table: ".toCharArray();
