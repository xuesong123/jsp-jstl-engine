 ...
 * JSP generated by JspCompiler-1.0.1.2 (built 2016-01-08 22:10:35 758)
 */
package _tpl._jsp;
...
public class OutTestTemplate extends JspTemplate {
    ...
    float myFloat = 1.1f;
        ...
        // NODE START: lineNumber: 22, offset: 30, length: 3, tagClassName: com.skin.ayada.jstl.core.IfTag, tagInstanceName: _jsp_IfTag_31
        // <c:if test=\"${util.notEmpty(userList)}\">...</c:if>
        if(ExpressionUtil.getBoolean(expressionContext, "${util.notEmpty(userList)}")) {
            // TEXT: lineNumber: 22
            // out.write("userList is not empty !");
        ...
        // NODE START: lineNumber: 23, offset: 34, length: 6, tagClassName: com.skin.ayada.jstl.core.OutTag, tagInstanceName: _jsp_OutTag_35
        ...
        // NODE START: lineNumber: 23, offset: 36, length: 2, tagClassName: com.skin.ayada.jstl.core.OutTag, tagInstanceName: _jsp_OutTag_37
        ...
        // jsp.jstl.core.OutTag END
        // NODE END: lineNumber: 23, tagClassName: com.skin.ayada.jstl.core.OutTag, tagInstanceName: _jsp_OutTag_37
    ...
    public static final char[] _jsp_string_32 = "userList is not empty !".toCharArray();
    public static final char[] _jsp_string_34 = "\r\n".toCharArray();
    public static final char[] _jsp_string_36 = "<div>".toCharArray();
    public static final char[] _jsp_string_39 = "</div>".toCharArray();
